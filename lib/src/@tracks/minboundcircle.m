...
%
% -------------------------------------------------------------------------
% Erik Maris 2019/01/14
% added check for duplicates at lines 91-106
%
% -------------------------------------------------------------
...
% check for duplicates in  coordinates with n == 3, since this sometimes 
% gives rounding errors in enc3.
if n == 3
    % convert to complex
    xy = x + sqrt(-1)*y;
    if xy(1) == xy(2)
